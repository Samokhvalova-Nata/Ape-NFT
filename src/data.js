...
export const FAQlist = [
 ...
 {
  text:
   'As an NFT owner, you can own, transfer, potentially access exclusive content, resell, but do not automatically get copyright or intellectual property rights.',
  title: 'WHAT RIGHTS DO I HAVE AS AN OWNER OF AN NFT?',
  src: [FAQimg4_1x, FAQimg4_2x],
 },
];

export const mainMapCards = [
  {
